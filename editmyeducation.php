...
<form class="user" method="post" action="">
   <?php
 $cid=$_SESSION['uid'];
$ret=mysqli_query($con,"select * from empeducation where FrmID='$cid'");
...
?>
               ...
               <div class="row">
                ...
                <div class="col-4 mb-3">Course SSC</div>
                   <div class="col-8 mb-3">   <input type="text" class="form-control form-control-user" id="coursessc" name="coursessc" aria-describedby="emailHelp" required="true" value="<?php  echo $row['CourseSSC'];?>"></div>
                    </div>  
                    <div class="row">
                ...
                <div class="col-4 mb-3">Course HSC</div>
                   <div class="col-8 mb-3">   <input type="text" class="form-control form-control-user" id="coursehsc" name="coursehsc" aria-describedby="emailHelp" required="true" value="<?php  echo $row['CourseHSC'];?>"></div>
                    </div>  
                    <div class="row">
